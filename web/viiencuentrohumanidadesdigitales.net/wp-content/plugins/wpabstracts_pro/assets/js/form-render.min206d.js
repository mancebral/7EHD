!(function (e) {
	...
	!(function (e) {
		...
		function (e, t, n) {
			...
			var l = (function () {
				function e(t, n) {
					...
					(this.classConfig = jQuery.extend({}, e.controlConfig[l] || {})),
		...
		function (t, n, r) {
			...
			var l = (n.trimObj = function (e) {
					...
					for (var n in e)
						t.includes(e[n])
							? delete e[n]
							: Array.isArray(e[n]) && (e[n].length || delete e[n]);
					return e;
				}),
			...
			var v = (n.parseAttrs = function (e) {
				...
				w = (n.parseOptions = function (e) {
					for (var t = [], n = 0; n < e.length; n++) {
						var r = o({}, v(e[n]), { label: e[n].textContent });
						t.push(r);
					}
					return t;
				}),
				...
				L = (n.merge = function e(t, n) {
					...
					for (var o in n)
						r.hasOwnProperty(o) &&
							(Array.isArray(n[o])
								? (r[o] = Array.isArray(t[o]) ? S(t[o].concat(n[o])) : n[o])
								: 'object' === i(n[o])
								? (r[o] = e(t[o], n[o]))
								: (r[o] = n[o]));
					return r;
							...
							return (
								(e.prototype.processConfig = function (e) {
									...
									var s = this.config,
										...
										u = s.preloaded,
										c = void 0 === u ? {} : u,
										f = Object.entries(this.langs).concat(
											Object.entries(l || c)
										);
			...
			var s = (function (e) {
				...
				return (
					...
					(t.register = function () {
						...
						t.def.i18n[r] || (t.def.i18n[r] = {}),
							o.default.register(Object.keys(e), t);
						var a = n,
							s = Array.isArray(a),
							l = 0;
						for (a = s ? a : a[Symbol.iterator](); ; ) {
							...
							if (!e[f]) {
								...
								(d = c.datatype
									? c.datatype
									: f + '-' + Math.floor(9e3 * Math.random() + 1e3)),
									(t.customRegister[d] = jQuery.extend(c, {
										type: f,
										class: p,
									}));
							}
					...
					(t.prototype.build = function () {
						...
						return (
							(e = (e = e.bind(this))(n)).js && (this.js = e.js),
			...
			var r = (t.instanceDom = {}),
				...
				a = (t.filter = function (e, t) {
					...
					for (var o = e.length - 1; o >= 0; o--) {
						-1 !== e[o].textContent.toLowerCase().indexOf(t.toLowerCase())
							? ((e[o].style.display = r[0]), n.push(e[o]))
							: (e[o].style.display = r[1]);
					}
					return n;
				}),
				s = (t.optionFields = [
						...
						if (
							...
							for (var p = 0; p < n.length; p++) {
								...
								var m = h,
									...
									y = void 0 === b ? '' : b;
								if (
									(((k = a(m, ['label'])).id = c.id + '-' + p),
									(k.selected && !o) || delete k.selected,
									void 0 !== r && k.value === r && (k.selected = !0),
									d)
								) {
									...
									s && (w += '-inline'),
										(k.type = f),
										k.selected && ((k.checked = 'checked'), delete k.selected);
									var x = this.markup('input', null, Object.assign({}, c, k)),
										q = { for: k.id },
										O = [x, this.markup('label', v, q)];
									u &&
										((q.className = 'kc-toggle'),
										v.unshift(x, this.markup('span')),
										(O = this.markup('label', v, q)));
									var j = this.markup('div', O, { className: w });
									e.push(j);
								}
							}
							if (!d && l) {
								...
								var E = {
									...
									T = [
										...
										this.markup('input', null, E),
									],
									_ = this.markup('label', T, { for: k.id }),
									R = this.markup('div', [A, _], { className: S });
								e.push(R);
							}
						}
						return (
		...
		function (e, t, n) {
			...
			(t.default = a),
				r.default.register(['paragraph', 'header'], a),
				r.default.register(
					['p', 'address', 'blockquote', 'canvas', 'output'],
					a,
					'paragraph'
				),
				r.default.register(['h1', 'h2', 'h3', 'h4'], a, 'header');
		},
		function (t, n, r) {
			n.__esModule = !0;
			var o = (function (e) {
		...
		function (e, t, n) {
			...
			(t.default = o),
				r.default.register('button', o),
				r.default.register(['button', 'submit', 'reset'], o, 'button');
		},
		function (t, n, r) {
			n.__esModule = !0;
			var o = (function () {
					...
					!(function (e, t) {
						...
						(this.templates = {
							...
							default: function (e, t, n, o) {
								n && t.appendChild(n);
								var i = o.id
									? 'fb-' + o.type + ' form-group field-' + o.id
									: '';
								if (o.className) {
								...
								return r.markup('div', [t, e], { className: i });
							},
							noLabel: function (e, t, n, o) {
								var i = o.id
									? 'fb-' + o.type + ' form-group field-' + o.id
									: '';
								return r.markup('div', e, { className: i });
							},
					...
					(e.prototype.build = function (e, t, n) {
						this.preview &&
							(t.name
								...
								: (t.name = o.default.nameAttr(t) + '-preview')),
							(t.id = t.name),
							(this.data = jQuery.extend({}, t));
						var i = new e(t, this.preview),
							a = i.build();
						('object' === (void 0 === a ? 'undefined' : r(a)) && a.field) ||
							(a = { field: a });
						var s = this.label(),
							l = this.help(),
							u = void 0;
						...
						return (
							i.on('prerender')(c),
							c.addEventListener('fieldRendered', i.on('render')),
							c
						);
					}),
		...
		function (t, n, r) {
			...
			var b = (function () {
				function t() {
					...
					if (
						((this.options = jQuery.extend(!0, n, e)),
						(this.instanceContainers = []),
						s.default.current || s.default.init(this.options.i18n),
						!this.options.formData)
					)
						return !1;
					(this.options.formData = this.parseFormData(this.options.formData)),
						(d.default.controlConfig = e.controlConfig || {}),
						d.default.loadCustom(e.controls),
						Object.keys(this.options.templates).length &&
							p.default.register(this.options.templates),
				...
				return (
					(t.prototype.santizeField = function (e, t) {
						...
						return (
							...
							(n.className = Array.isArray(e.className)
								? u.default.unique(e.className.join(' ').split(' ')).join(' ')
							...
							get: function () {
								...
								return (
									...
									this.instanceContainers.forEach(function (n, r) {
										for (
											var o = e('select, input, textarea', n)
													.serializeArray()
													.reduce(function (e, t) {
														var n = t.name,
															r = t.value;
											...
											var s = t[a];
											void 0 !== s.name &&
												(s.disabled || (s.userData = o[s.name]));
										}
									}),
									t
								);
