!(function (e) {
	...
	!(function (e) {
		...
		function (e, t, r) {
			...
			var s = (function () {
				function e(t, r) {
					...
					(this.classConfig = jQuery.extend({}, e.controlConfig[s] || {})),
				...
				return (
					...
					(e.loadCustom = function (t) {
						...
						if (
							(t && (r = r.concat(t)),
							window.fbControls && (r = r.concat(window.fbControls)),
						...
						var t = this,
							r = {
								...
								render: function (e) {
									...
									t.css && (0, a.getStyles)(t.css),
										t.js && !(0, a.isCached)(t.js)
											? (0, a.getScripts)(t.js).done(r)
											: r();
								},
							};
						return e ? r[e] : r;
			...
			var y = (r.parseAttrs = function (e) {
				...
				w = (r.parseOptions = function (e) {
					for (var t = [], r = 0; r < e.length; r++) {
						var o = n({}, y(e[r]), { label: e[r].textContent });
						t.push(o);
					}
					return t;
				}),
				x = (r.parseXML = function (e) {
					...
					if (t)
						for (
							var o = t.getElementsByTagName('field'), n = 0;
							n < o.length;
							n++
						) {
							var i = y(o[n]),
				...
				S = (r.getScripts = function (e, t) {
					...
					return (
						Array.isArray(e) || (e = [e]),
						T(e) ||
							(n = jQuery.map(e, function (e) {
								var r = { dataType: 'script', cache: !0, url: (t || '') + e };
				...
				D = (r.merge = function e(t, r) {
					...
					for (var n in r)
						o.hasOwnProperty(n) &&
							(Array.isArray(r[n])
								? (o[n] = Array.isArray(t[n]) ? j(t[n].concat(r[n])) : r[n])
								: 'object' === i(r[n])
								? (o[n] = e(t[n], r[n]))
								: (o[n] = r[n]));
					return o;
							...
							return (
								(e.prototype.processConfig = function (e) {
									...
									var l = this.config,
										...
										u = l.preloaded,
										f = void 0 === u ? {} : u,
										c = Object.entries(this.langs).concat(
											Object.entries(s || f)
										);
										...
										if (t && n)
											if ('object' === (void 0 === t ? 'undefined' : o(t)))
												for (var a = 0; a < n.length; a++)
													(i = n[a].substring(1, n[a].length - 1)),
														(r = r.replace(this.makeSafe(n[a]), t[i] || ''));
					...
					(o.prototype = new Error()),
						...
						(e.exports = function (e) {
							for (
								...
								n.charAt(0 | a) || ((l = '='), a % 1);
								i += l.charAt(63 & (t >> (8 - (a % 1) * 8)))
							) {
								if ((r = n.charCodeAt((a += 0.75))) > 255) throw new o();
								t = (t << 8) | r;
							}
							return i;
						});
		...
		function (t, r, o) {
			...
			var a = (function (t) {
				...
				return (
					...
					(r.prototype.build = function () {
						...
						return (
							(this.field = this.markup('textarea', this.parsedHtml(r), o)),
							this.field
						);
					}),
					...
					(r.prototype.on = function (r) {
						var o = this;
						return 'prerender' == r && this.preview
							? function (t) {
									o.field && (t = o.field),
			...
			(r.default = a),
				i.default.register('textarea', a),
				i.default.register('textarea', a, 'textarea');
		},
		function (e, t, r) {
			t.__esModule = !0;
			var o = (function () {
				...
				return (
					...
					(t.register = function () {
						var e =
							...
							r =
								arguments.length > 1 && void 0 !== arguments[1]
									...
									: [];
						(t.customRegister = {}),
							t.def || (t.def = { icon: {}, i18n: {} }),
							(t.templates = e);
						var o = i.default.locale;
						t.def.i18n[o] || (t.def.i18n[o] = {}),
							n.default.register(Object.keys(e), t);
						var a = r,
							l = Array.isArray(a),
							s = 0;
						for (a = l ? a : a[Symbol.iterator](); ; ) {
							...
							if (!e[c]) {
								...
								(d = f.datatype
									? f.datatype
									: c + '-' + Math.floor(9e3 * Math.random() + 1e3)),
									(t.customRegister[d] = jQuery.extend(f, {
										type: c,
										class: p,
									}));
							}
					...
					(t.getRegistered = function () {
						var e =
							arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
						return e
							? n.default.getRegistered(e)
							: Object.keys(t.customRegister);
					}),
					(t.lookup = function (e) {
					...
					(t.prototype.build = function () {
						...
						return (
							(e = (e = e.bind(this))(r)).js && (this.js = e.js),
			...
			var o = (t.instanceDom = {}),
				...
				a = (t.filter = function (e, t) {
					...
					for (var n = e.length - 1; n >= 0; n--) {
						-1 !== e[n].textContent.toLowerCase().indexOf(t.toLowerCase())
							? ((e[n].style.display = o[0]), r.push(e[n]))
							: (e[n].style.display = o[1]);
					}
					return r;
				}),
				l = (t.optionFields = [
		...
		function (t, r, o) {
			...
			(r.default = a),
				i.default.register(['text', 'file', 'date', 'number'], a),
				i.default.register(
		...
		function (e, t, r) {
			...
			function c(e, t) {
				for (var r = [], o = {}, n = 0; n < e.length; n++) {
					...
					o[a] ? o[a].parts.push(l) : r.push((o[a] = { id: a, parts: [l] }));
				}
				return r;
			}
			function d(e, t) {
		...
		function (e, t, r) {
			(t.__esModule = !0),
				(t.config = t.defaultI18n = t.styles = t.defaultOptions = void 0),
				(function (e) {
					return e && e.__esModule ? e : { default: e };
				...
				return (
					...
					(t.prototype.onRender = function (e) {
						...
						(o.instance = new window.Quill(this.field, {
							...
							(o.data = new r()),
							t &&
								o.instance.setContents(window.JSON.parse(this.parsedHtml(t))),
			...
			var n = (function (e) {
				...
				return (
					...
					(t.prototype.build = function () {
						...
						return (
							(this.field = this.markup('textarea', this.parsedHtml(r), o)),
							o.disabled && (this.editorOptions.readonly = !0),
							this.field
						);
					}),
					(t.prototype.onRender = function (e) {
						...
						if (
							...
							for (var p = 0; p < r.length; p++) {
								...
								var b = m,
									...
									g = void 0 === h ? '' : h;
								if (
									(((q = a(b, ['label'])).id = f.id + '-' + p),
									(q.selected && !n) || delete q.selected,
									void 0 !== o && q.value === o && (q.selected = !0),
									d)
								) {
									...
									l && (w += '-inline'),
										(q.type = c),
										q.selected && ((q.checked = 'checked'), delete q.selected);
									var x = this.markup('input', null, Object.assign({}, f, q)),
										A = { for: q.id },
										O = [x, this.markup('label', y, A)];
									u &&
										((A.className = 'kc-toggle'),
										y.unshift(x, this.markup('span')),
										(O = this.markup('label', y, A)));
									var k = this.markup('div', O, { className: w });
									e.push(k);
								}
							}
							if (!d && s) {
								...
								var C = {
									...
									T = [
										...
										this.markup('input', null, C),
									],
									L = this.markup('label', T, { for: q.id }),
									N = this.markup('div', [S, L], { className: j });
								e.push(N);
							}
						}
						return (
		...
		function (e, t, r) {
				...
				return (
					...
					(t.prototype.build = function () {
						var e = this.config,
							...
							o = t,
							i = { paragraph: 'p', header: this.subtype };
						return (
							i[t] && (o = i[t]),
							{
			...
			(t.default = a),
				o.default.register(['paragraph', 'header'], a),
				o.default.register(
					['p', 'address', 'blockquote', 'canvas', 'output'],
					a,
					'paragraph'
				),
				o.default.register(['h1', 'h2', 'h3', 'h4'], a, 'header');
		},
		function (t, r, o) {
			r.__esModule = !0;
			var n = (function (e) {
		...
		function (e, t, r) {
			...
			(t.default = n),
				o.default.register('button', n),
				o.default.register(['button', 'submit', 'reset'], n, 'button');
		},
		function (t, r, o) {
			r.__esModule = !0;
			var n = (function () {
			...
			var l = (function (t) {
				...
				return (
						...
						var e = this,
							...
							l = {
								focus: function (t) {
									...
									if (
										(t.target.addEventListener('keydown', i),
								...
								blur: function (t) {
									if (
										(t.target.removeEventListener('keydown', i),
										setTimeout(function () {
					...
					(r.prototype.selectOption = function (e, t) {
						for (var r = e.querySelectorAll('li'), o = 0; o < r.length; o++)
							r[o].classList.remove('active-option');
						t && t.classList.add('active-option');
					}),
					(r.prototype.isOptionValid = function (e, t) {
						for (
							var r = e.querySelectorAll('li'), o = !1, n = 0;
							n < r.length;
							n++
						)
							if (r[n].innerHTML === t) {
						...
						if (this.config.userData) {
							...
							if (
								...
								return this.config.requireValidOption
									? void 0
									: void r.prev().val(this.config.userData[0]);
					...
					!(function (e, t) {
						...
						(this.templates = {
							...
							default: function (e, t, r, n) {
								r && t.appendChild(r);
								var i = n.id
									? 'fb-' + n.type + ' form-group field-' + n.id
									: '';
								if (n.className) {
									var a = n.className.split(' ').filter(function (e) {
										return (
											/^col-(xs|sm|md|lg)-([^\s]+)/.test(e) ||
											e.startsWith('row-')
										);
									});
									if (a && a.length > 0) {
								...
								return o.markup('div', [t, e], { className: i });
							},
							noLabel: function (e, t, r, n) {
								var i = n.id
									? 'fb-' + n.type + ' form-group field-' + n.id
									: '';
								return o.markup('div', e, { className: i });
							},
							hidden: function (e, t, r, o) {
								return e;
							},
						}),
						t && (this.templates = jQuery.extend(this.templates, t)),
						this.configure();
				}
				return (
					(e.prototype.configure = function () {}),
					(e.prototype.build = function (e, t, r) {
						this.preview &&
							(t.name
								...
								: (t.name = n.default.nameAttr(t) + '-preview')),
							(t.id = t.name),
							(this.data = jQuery.extend({}, t));
						var i = new e(t, this.preview),
							a = i.build();
						('object' === (void 0 === a ? 'undefined' : o(a)) && a.field) ||
							(a = { field: a });
						var l = this.label(),
							s = this.help(),
							u = void 0;
						u =
							r && this.isTemplate(r)
								? r
								: this.isTemplate(a.layout)
								? a.layout
								: 'default';
						var f = this.processTemplate(u, a.field, l, s);
						return (
							i.on('prerender')(f),
							f.addEventListener('fieldRendered', i.on('render')),
							f
						);
					}),
					(e.prototype.label = function () {
						...
						return (
							this.data.required &&
								t.push(this.markup('span', '*', { className: 'fb-required' })),
					...
					(e.prototype.processTemplate = function (e) {
						for (
							var t, r = arguments.length, o = Array(r > 1 ? r - 1 : 0), n = 1;
							n < r;
							n++
						)
							o[n - 1] = arguments[n];
			...
			var s = (function () {
				function e(t, r) {
					!(function (e, t) {
						...
						(this.opts = t),
						(this.dom = r.controls),
						(this.custom = n.default),
						(this.getClass = o.default.getClass),
						(this.getRegistered = o.default.getRegistered),
						(o.default.controlConfig = t.controlConfig || {}),
						this.init();
				}
				return (
					...
					(e.prototype.setupControls = function () {
						var e = this,
							t = this.opts;
						o.default.loadCustom(t.controls),
							Object.keys(t.fields).length &&
								n.default.register(t.templates, t.fields);
						var r = o.default.getRegistered();
						this.registeredControls = r;
						var a = n.default.getRegistered();
						a && jQuery.merge(r, a),
							t.sortableControls && this.dom.classList.add('sort-enabled'),
							(this.controlList = []),
							(this.allControls = {});
						for (var l = 0; l < r.length; l++) {
							var s = r[l],
								...
								f = void 0;
							if (u) f = u.class;
							else if (((u = {}), !(f = o.default.getClass(s)) || !f.active(s)))
								continue;
							var c = u.icon || f.icon(s),
								d = u.label || f.label(s),
								p = c
									? ''
									: u.iconClassName || 'icon-' + s.replace(/-[\d]{4}$/, '');
							c && (d = '<span class="control-icon">' + c + '</span>' + d);
							var m = (0, i.markup)('li', (0, i.markup)('span', d), {
								className: p + ' input-control input-control-' + l,
							});
							(m.dataset.type = s),
								this.controlList.push(s),
								(this.allControls[s] = m);
						}
						t.inputSets.length &&
							t.inputSets.forEach(function (t, r) {
								var o = t.name,
									n = t.label;
								(o = o || (0, i.hyphenCase)(n)),
									t.icon &&
										(n =
											'<span class="control-icon">' + t.icon + '</span>' + n);
								var a = (0, i.markup)('li', n, {
									className: 'input-set-control input-set-' + r,
								});
								(a.dataset.type = o),
									e.controlList.push(o),
									(e.allControls[o] = a);
							});
					}),
					...
					(e.prototype.appendControls = function () {
						var e = this;
						(0, a.empty)(this.dom),
							this.orderFields(this.controlList).forEach(function (t) {
			...
			var b = (function () {
				function t(e, r, o) {
					!(function (e, t) {
						...
						(this.data = l.instanceData[e]),
						(this.d = a.instanceDom[e]),
						(this.doCancel = !1),
						(this.layout = r),
				...
				return (
					(t.prototype.startMoving = function (e, t) {
					...
					(t.prototype.beforeStop = function (e, t) {
						var r = f.config.opts,
							...
							n = [];
						(this.stopIndex = t.placeholder.index() - 1),
							!r.sortableControls &&
								t.item.parent().hasClass('frmb-control') &&
								n.push(!0),
							r.prepend && n.push(0 === this.stopIndex),
							r.append && n.push(this.stopIndex + 1 === o),
							(this.doCancel = n.some(function (e) {
								return !0 === e;
							}));
					}),
					(t.prototype.getTypes = function (t) {
						var r = { type: t.attr('type') },
					...
					(t.prototype.prepData = function (t) {
						...
						return (
							0 !== t.childNodes.length &&
								(0, s.forEach)(t.childNodes, function (t, i) {
									var a = e(i);
									if (!a.hasClass('disabled-field')) {
										...
										if ((l = Object.assign({}, l, n.getAttrVals(i))).subtype)
											if ('quill' === l.subtype) {
												...
												if (window.fbEditors.quill[c]) {
													var d =
														window.fbEditors.quill[c].instance.getContents();
										...
										(l = (0, s.trimObj)(l)).type &&
											l.type.match(o.optionFieldsRegEx) &&
											(l.values = n.fieldOptionData(a)),
											r.push(l);
									}
								}),
							r
					...
					(t.prototype.getData = function (e) {
						...
						return (
							(t.formData = r[f.config.opts.dataType](e) || []), t.formData
						);
					}),
					(t.prototype.save = function (e) {
						...
						return (
							(r.formData = n[f.config.opts.dataType](e)),
							document.dispatchEvent(u.default.formSaved),
							r.formData
						);
					}),
					...
					(t.prototype.getAttrVals = function (t) {
						...
						return (
							(0, s.forEach)(o, function (t) {
								var i = o[t],
									a = (0, s.camelCase)(i.getAttribute('name')),
									l = [
										[
											i.attributes.contenteditable,
											function () {
												return 'xml' === f.config.opts.dataType
													? (0, s.escapeHtml)(i.innerHTML)
													: i.innerHTML;
											},
										],
										[
					...
					(t.prototype.updatePreview = function (t) {
						...
						if (!o.includes('input-control')) {
							var i = t.attr('type'),
								l = e('.prev-holder', n),
								f = Object.assign({}, this.getAttrVals(n, f), { type: i }),
								p = e('.btn-style', n).val();
							p && (f.style = p),
								i.match(r.optionFieldsRegEx) &&
									((f.values = []),
									(f.multiple = e('[name="multiple"]', n).is(':checked')),
								...
								((f = (0, s.trimObj)(f)).className = this.classNames(n, f)),
								t.data('fieldData', f);
							...
							(0, a.empty)(l[0]),
								l[0].appendChild(h),
								h.dispatchEvent(u.default.fieldRendered);
						}
					}),
					(t.prototype.disabledTT = function (e) {
						...
						(0, s.forEach)(t, function (e) {
							...
							if (o) {
								var n = (0, s.markup)('p', o, { className: 'frmb-tt' });
								r.appendChild(n),
					...
					(t.prototype.confirm = function (e, t) {
						...
						var c = (0, s.markup)('div', [f, u], { className: 'button-wrap' });
						o = 'form-builder-dialog ' + o;
						var d = (0, s.markup)('div', [e, c], { className: o });
						...
						return (
							(d.style.left = r.pageX + 'px'),
							(d.style.top = r.pageY + 'px'),
					...
					(t.prototype.dialog = function (e) {
						...
						var i = (0, s.markup)('div', e, { className: r });
						return (
							t
							...
							document.dispatchEvent(u.default.modalOpened),
							-1 !== r.indexOf('data-dialog') &&
								document.dispatchEvent(u.default.viewData),
							i
						);
					}),
					(t.prototype.confirmRemoveAll = function (t) {
						var r = this,
							...
							c = { pageX: s.left + s.width / 2, pageY: s.top - u.top - 12 };
						l.length
							? r.confirm(
									a.clearAllMessage,
									function () {
										r.removeAllFields.call(r, n),
											f.config.opts.notify.success(a.allFieldsRemoved),
											f.config.opts.onClearAll();
									},
									c
							  )
							: r.dialog(a.noFieldsToClear, c);
					}),
					(t.prototype.removeAllFields = function (e) {
						...
						if (
							...
							u.some(function (e) {
								...
								(e.classList.add('empty'), (e.dataset.content = o.getStarted)),
							r)
						) {
					...
					(t.prototype.setFieldOrder = function (t) {
						...
						return (
							...
							o && o.setItem('fieldOrder', n.stringify(i)),
							i
						);
					}),
						...
						o.classList.toggle('editing'),
							...
							o.classList.contains('editing')
								? ((this.formBuilder.currentEditPanel = n[0]),
								  f.config.opts.onOpenFieldEdit(n[0]),
								  document.dispatchEvent(u.default.fieldEditOpened))
								: (f.config.opts.onCloseFieldEdit(n[0]),
								  document.dispatchEvent(u.default.fieldEditClosed));
					}),
					...
					(t.prototype.stickyControls = function () {
						...
						e(window).scroll(function (t) {
							var l = e(t.target).scrollTop(),
								s = { top: 5, bottom: 'auto', right: 'auto', left: i.left },
								u = Object.assign({}, s, f.config.opts.stickyControls.offset);
							if (l > a) {
								var c = Object.assign({ position: 'sticky' }, u),
					...
					(t.prototype.removeField = function (t) {
						...
						if (!l.length)
							return f.config.opts.notify.warning('No fields to remove'), !1;
						if (!t) {
							var s = [].slice.call(l).map(function (e) {
								return e.id;
							});
							f.config.opts.notify.warning(
								'fieldID required to remove specific fields.'
							),
								f.config.opts.notify.warning(
									'Removing last field since no ID was supplied.'
								),
								f.config.opts.notify.warning('Available IDs: ' + s.join(', ')),
								(t = a.lastChild.id);
						}
						...
						d.slideUp(r, function () {
							d.removeClass('deleting'),
								d.remove(),
								(o = !0),
								n.save(),
								a.childNodes.length ||
									(a.classList.add('empty'),
									(a.dataset.content = i.default.current.getStarted));
						});
						var p = f.config.opts.typeUserEvents[c.type];
						return (
							p && p.onremove && p.onremove(c),
							document.dispatchEvent(u.default.fieldRemoved),
							o
						);
					}),
					(t.prototype.processActionButtons = function (e) {
						var t = e.label,
							...
							a = this.data;
						(n = n
							? i.default.current[n] || n
							: o.id
							? i.default.current[o.id] || (0, s.capitalize)(o.id)
							: ''),
							o.id
								? (o.id = a.formID + '-' + o.id + '-action')
								: (o.id =
										a.formID + '-action-' + Math.round(1e3 * Math.random()));
					...
					(t.prototype.processSubtypes = function (e) {
						...
						for (var r in e)
							e.hasOwnProperty(r) &&
								c.default.register(e[r], c.default.getClass(r), r);
					...
					(t.prototype.formActionButtons = function () {
						var e = this,
							t = f.config.opts;
						return t.actionButtons
							.map(function (r) {
								if (r.id && -1 === t.disabledActionButtons.indexOf(r.id))
									return e.processActionButtons(r);
							})
							.filter(Boolean);
					}),
		...
		function (e, t, r) {
			...
			var n = {
				attrs: { class: 'formBuilder-injected-style' },
				sourceMap: !1,
				hmr: !0,
				transform: void 0,
				insertInto: void 0,
		...
		function (t, r, o) {
			...
			var y = function (t, r) {
				...
				var O = new t.layout(t.layoutTemplates, !0),
					...
					q = h.markup;
				(t = k.processOptions(t)),
					(x.layout = k.editorLayout(t.controlPosition)),
					k.editorUI(w),
					(x.formID = w),
					(x.lastID = x.formID + '-fld-1');
				...
				C.sortable({
					...
					t.allowStageSort || C.sortable('disable'),
					S.sortable({
						helper: 'clone',
						opacity: 0.9,
						connectWith: C,
						...
						update: function (e, r) {
							...
							r.item.parent()[0] === A.stage
								? ((k.doCancel = !0), T(r.item))
								: (k.setFieldOrder(S), (k.doCancel = !t.sortableControls));
						},
					});
				var T = function (e) {
						if (e[0].classList.contains('input-set-control')) {
							var r = [],
								o = t.inputSets.find(function (t) {
									return (
										(0, h.hyphenCase)(t.name || t.label) === e[0].dataset.type
									);
								});
							if (o && o.showHeader) {
								var n = {
				...
				t.showActionButtons && N.appendChild(A.formActions),
					L.append(A.stage, N),
					'textarea' !== r.type ? e(r).append(L) : e(r).replaceWith(L),
					e(A.controls).on('click', 'li', function (t) {
						var r = t.target,
							o = e(r).closest('li');
				...
				var D = function (r) {
						...
						if (r instanceof jQuery)
							if (((n.type = r[0].dataset.type), n.type)) {
								...
								o ||
									(n.values = r.children().map(function (t, r) {
										return {
											label: e(r).text(),
								...
								for (var s = l.length - 1; s >= 0; s--)
									n[l[s].name] = l[s].value;
							}
						else n = Object.assign({}, r);
						n.name || (n.name = (0, h.nameAttr)(n)),
							o &&
								[
									'text',
									'number',
						...
						u && (n.style = u[1]),
							o &&
								((n = Object.assign({}, n, t.onAddField(x.lastID, n))),
								setTimeout(function () {
									return document.dispatchEvent(c.default.fieldAdded);
								}, 10)),
							W(n, o),
							A.stage.classList.remove('empty');
					},
					M = function (r) {
						(r = k.getData(r)) && r.length
							? (r.forEach(function (e) {
									return D((0, h.trimObj)(e));
							  }),
							  A.stage.classList.remove('empty'))
							: t.defaultFields && t.defaultFields.length
							? (t.defaultFields.forEach(function (e) {
									return D(e);
							  }),
							  A.stage.classList.remove('empty'))
							: t.prepend ||
							  t.append ||
							  (A.stage.classList.add('empty'),
							  (A.stage.dataset.content = f.default.get('getStarted'))),
							(function () {
								var r = [],
									o = function (e) {
										return q('li', t[e], {
								...
								return (
									t.prepend &&
										!e('.disabled-field.form-prepend', A.stage).length &&
										(r.push(!0), C.prepend(o('prepend'))),
									t.append &&
										!e('.disabled-field.form-.append', A.stage).length &&
										(r.push(!0), C.append(o('append'))),
									k.disabledTT(A.stage),
									r.some(function (e) {
										return !0 === e;
									})
								);
					...
					R = function (e) {
						var t = e.type,
							...
							n = void 0,
							i = [
								q('a', f.default.get('addOption'), {
									className: 'add add-opt',
								}),
							],
							a = [
								q('label', f.default.get('selectOptions'), {
						...
						if (r && r.length)
							n = r.map(function (e) {
								return Object.assign({}, { selected: !1 }, e);
							});
						else {
							var s = [1, 2, 3];
							...
							var u = (n = s.map(function (e) {
								return (function (e) {
									var r = { label: e, value: (0, h.hyphenCase)(e) };
									return 'autocomplete' !== t && (r.selected = !1), r;
								})('' + f.default.get('optionCount', e));
							}))[0];
							u.hasOwnProperty('selected') &&
								'radio-group' !== t &&
								(u.selected = !0);
						}
						var c = q('div', i, { className: 'option-actions' }),
							d = q(
								'ol',
								n.map(function (e) {
									return J(o, e, l);
							...
							p = q('div', [d, c], { className: 'sortable-options-wrap' });
						return (
							a.push(p),
							q('div', a, { className: 'form-group field-options' }).outerHTML
						);
					},
					B = function (e) {
						var r = e.type,
							...
							i = (function (e) {
								...
								var n = o[e];
								return (
									'radio-group' === e && (0, h.removeFromArray)('toggle', n),
									['header', 'paragraph', 'button'].includes(e) &&
										(0, h.removeFromArray)('description', n),
									r || (0, h.removeFromArray)('value', n),
									n || t
								);
							})(r),
							a = {
								...
								toggle: function () {
									return z('toggle', e, { first: f.default.get('toggle') });
								},
								inline: function () {
									var t = {
										first: f.default.get('inline'),
										second: f.default.get(
											'inlineDesc',
											r.replace('-group', '')
										),
									};
								...
								access: function () {
									...
									for (l in t.roles)
										if (t.roles.hasOwnProperty(l)) {
											...
											s.includes(l) && (n.checked = 'checked'),
												r.push('<label for="' + o + '">'),
												r.push(k.input(n).outerHTML),
												r.push(' ' + t.roles[l] + '</label>');
										}
									r.push('</div>');
									var i = {
						...
						if (
							(Object.keys(i).forEach(function (e) {
								...
								s && !u.includes(n) && l.push(!1),
									l.every(Boolean) && o.push(a[n](s));
							}),
							t.typeUserAttrs[r])
						) {
							var c = (function (e, t) {
				...
				function I(e, t) {
					...
					return (
						['checkbox', 'checkbox-group', 'radio-group'].includes(i.type) ||
							i.className.push('form-control'),
						(i = Object.assign({}, n, i)),
				...
				function P(e, t) {
					var r = t.multiple,
						...
						u = Object.keys(o).map(function (e) {
							var t = { value: e };
							return (
								(Array.isArray(i) ? i.includes(e) : e === i) &&
									(t.selected = null),
								q('option', o[e], t)
							);
						}),
				...
				var z = function (e, t) {
						var r =
								arguments.length > 2 && void 0 !== arguments[2]
									...
									: {},
							o = function (t) {
								return q('label', t, { for: e + '-' + x.lastID }).outerHTML;
							},
							n = {
								type: 'checkbox',
								className: 'fld-' + e,
						...
						return (
							...
							r.second && a.push(' ', o(r.second)),
							r.content && a.push(r.content),
							(a = q('div', a, { className: 'input-wrap' }).outerHTML),
							q('div', i.concat(a), { className: 'form-group ' + e + '-wrap' })
								.outerHTML
						);
					},
					U = function (e) {
						...
						return (
							...
							m.styles.btn.forEach(function (r) {
					...
					Q = function (e, t, r) {
						var o = r.map(function (r, o) {
								var n = Object.assign(
									{ label: y.option + ' ' + o, value: void 0 },
									r
								);
								return (
									r.value === t[e] && (n.selected = !0),
									(n = (0, h.trimObj)(n)),
									q('option', n.label, n)
								);
							}),
							...
							a = q('label', i, { for: n.id }),
							l = q('select', o, n),
							s = q('div', l, { className: 'input-wrap' });
						return q('div', [a, s], {
					...
					V = function (e, r) {
						var o =
							...
							i = f.default.get(e);
						'label' === e &&
							(['paragraph'].includes(r.type)
								? (i = f.default.get('content'))
								: (n = (0, h.parsedHtml)(n)));
						...
						if (
							...
							var s = {
								...
								u = q('label', i, { for: s.id }).outerHTML;
							'label' !== e || t.disableHTMLLabels
								? ((s.value = n),
								  (s.type = 'text'),
								  (l += '<input ' + (0, h.attrString)(s) + '>'))
								: ((s.contenteditable = !0), (l += q('div', n, s).outerHTML));
							var c = '<div class="input-wrap">' + l + '</div>',
								d = o ? 'none' : 'block';
							'value' === e &&
								(d = r.subtype && 'quill' === r.subtype && 'none'),
								(l = q('div', [u, c], {
									className: 'form-group ' + e + '-wrap',
									style: 'display: ' + d,
								}));
					...
					Y = function (e) {
						...
						return (
							...
							r.some(function (e) {
								...
								(o = z('required', e, { first: f.default.get('required') })),
							o
						);
					},
					W = function (r) {
						...
						var s = [q('div', l, { className: 'field-actions' })];
						s.push(
							q('label', (0, h.parsedHtml)(i), { className: 'field-label' })
						),
							s.push(
								q('span', ' *', {
						...
						s.push(q('span', '?', u)),
							s.push(q('div', '', { className: 'prev-holder' }));
						var c = q(
								'div',
								[
									B(r),
									q('a', f.default.get('close'), { className: 'close-field' }),
								],
						...
						var p = q('li', s, {
							...
							m = e(p);
						m.data('fieldData', { attrs: r }),
							void 0 !== k.stopIndex
								? e('> li', A.stage).eq(k.stopIndex).before(m)
								: C.append(m),
							e('.sortable-options', m).sortable({
								update: function () {
							...
							k.updatePreview(m),
							t.typeUserEvents[n] &&
								t.typeUserEvents[n].onadd &&
								t.typeUserEvents[n].onadd(p),
							o &&
								(t.editOnAdd && (k.closeAllEdit(), k.toggleEdit(x.lastID, !1)),
								p.scrollIntoView &&
					...
					J = function (e, t, r) {
						var o = { selected: r ? 'checkbox' : 'radio' },
							n = ['value', 'label', 'selected'],
							i = [];
						t = Object.assign({ selected: !1, label: '', value: '' }, t);
						for (var a = n.length - 1; a >= 0; a--) {
							...
							if (t.hasOwnProperty(l)) {
								...
								(s.placeholder = f.default.get('placeholder.' + l) || ''),
									'selected' === l &&
										!0 === t.selected &&
										(s.checked = t.selected),
									i.push(q('input', null, s));
							}
						}
						var u = {
				...
				C.on(
						...
						function (t) {
							if (t) {
								if (
									...
									return !1;
								k.updatePreview(e(t.target).closest('.form-field')),
									k.save.call(k);
							}
						},
						333,
					...
					C.on('click touchstart', '.remove', function (r) {
						...
						r.preventDefault(),
							...
							!i.includes('checkbox')
								? t.notify.error('Error: ' + f.default.get('minOptionMessage'))
					...
					C.on('dblclick', 'li.form-field', function (t) {
						if (
							...
							var r =
								'li' == t.target.tagName
									? e(t.target).attr('id')
									: e(t.target).closest('li.form-field').attr('id');
							k.toggleEdit(r), (t.handled = !0);
						}
					}),
				...
				if (
					...
					(0, h.addEventListeners)(A.stage, 'keyup change', function (e) {
						...
						if (t.classList.contains('fld-label')) {
							...
							(0, h.closest)(t, '.form-field').querySelector(
								'.field-label'
							).innerHTML = (0, h.parsedHtml)(r);
						}
					}),
					...
					C.on('keyup', 'input[name="description"]', function (t) {
						...
						if ('' !== n)
							if (o.length) o.attr('tooltip', n).css('display', 'inline-block');
								...
								var i =
									'<span class="tooltip-element" tooltip="' + n + '">?</span>';
					...
					C.on('blur', 'input.fld-name', function (t) {
						(t.target.value = (0, h.safename)(t.target.value)),
							'' === t.target.value
								? e(t.target)
										.addClass('field-error')
										.attr('placeholder', f.default.get('cannotBeEmpty'))
								: e(t.target).removeClass('field-error');
					}),
						...
						var o = e(r.target).parent().parent('li'),
							n = (function (r) {
								...
								return (
									...
									a.attr('name', i),
									a.addClass('cloned'),
									e('.sortable-options', a).sortable(),
									t.typeUserEvents[n] &&
										t.typeUserEvents[n].onclone &&
										t.typeUserEvents[n].onclone(a[0]),
									(x.lastID = k.incrementId(x.lastID)),
									a
								);
							})(o);
					...
					C.on('click', '.style-wrap button', function (t) {
						...
						n.val(o),
							r.siblings('.btn').removeClass('selected'),
							r.addClass('selected'),
							k.updatePreview(n.closest('.form-field')),
							k.save.call(k);
					}),
					...
					C.on('click', 'input.fld-access', function (t) {
						...
						r.slideToggle(250, function () {
							o.is(':checked') ||
								e('input[type=checkbox]', r).removeAttr('checked');
						});
					}),
				...
				return (
					document.dispatchEvent(c.default.loaded),
					(g.actions = {
						getFieldTypes: function (e) {
							return e
								? (0, h.subtract)(E.getRegistered(), t.disableFields)
								: E.getRegistered();
						},
						...
						setLang: function (e) {
							f.default.setCurrent.call(f.default, e).then(function () {
								(A.stage.dataset.content = f.default.get('getStarted')),
									E.init(),
									A.empty(A.formActions),
									k.formActionButtons().forEach(function (e) {
						...
						toggleFieldEdit: function (e) {
							(Array.isArray(e) ? e : [e]).forEach(function (e) {
								['number', 'string'].includes(
									...
									('number' == typeof e
										? (e = A.stage.children[e].id)
										: /^frmb-/.test(e) || (e = A.stage.querySelector(e).id),
									k.toggleEdit(e));
							});
						},
					...
					A.onRender(A.controls, function () {
						setTimeout(function () {
							(A.stage.style.minHeight = A.controls.clientHeight + 'px'),
								t.stickyControls.enable && k.stickyControls(C);
						}, 0);
					}),
					g
				);
					...
					init: function (r, o) {
						...
						return (
							(t.instance = {
								...
								get formData() {
									return (
										t.instance.actions.getData &&
										t.instance.actions.getData('json')
									);
								},
								promise: new Promise(function (r, n) {
									f.default
										...
										.then(function () {
											o.each(function (r) {
												var n = new y(a, o[r]);
												e(o[r]).data('formBuilder', n),
													Object.assign(t, n.actions),
													(t.instance.actions = n.actions);
											}),
												delete t.instance.promise,
												r(t.instance);
										})
